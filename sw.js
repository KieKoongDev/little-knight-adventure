const CORE="little-knight-core-v2.2.0";
const CORE_ASSETS=["./","./index.html","./style.css?v=2.2.0","./bootstrap.js?v=2.2.0","./three-effects.js?v=2.2.0","./game.js?v=2.2.0","./manifest.webmanifest","./version-manifest.json"];
