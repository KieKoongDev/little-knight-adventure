const CORE="little-knight-core-v1.9.2";
const CORE_ASSETS=["./","./index.html","./style.css?v=1.9.2","./bootstrap.js?v=1.9.2","./three-effects.js?v=1.9.2","./game.js?v=1.9.2","./manifest.webmanifest","./version-manifest.json"];
